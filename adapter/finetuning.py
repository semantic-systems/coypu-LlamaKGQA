...
class InstructionDataset(Dataset):
    def __init__(self, data_path, model_path, max_words=30, partition='train'):
        ...
        tokenizer = Tokenizer(model_path= model_path + "/Llama7B_adapter" + '/tokenizer.model')
...
def get_args_parser():
    ...
    '''
    # adding kgqa dataset
    #parser.add_argument('--data_path', default='../kgqa/coypu-questions-all.json', type=str,
                        help='dataset path for kgqa')
    parser.add_argument('--output_dir', default='./kgqa_output_dir',
                        help='path where to save trained kgqa model weight, empty for no saving')
    '''
